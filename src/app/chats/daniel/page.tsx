    ...
    <div className="flex flex-col h-screen max-w-md mx-auto bg-white">
      ...
      <div className="flex items-center p-4 border-b">
        ...
        <div className="flex items-center">
          ...
          <div>
            <h1 className="font-bold text-lg">Daniel Mudimba</h1>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-100">
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="bg-gray-200 rounded-2xl py-2 px-4 max-w-[80%]">
            <p>Hey David, I've been working on the new design</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="bg-gray-200 rounded-2xl py-2 px-4 max-w-[80%]">
            ...
            <p>What do you think about this layout?</p>
          </div>
        </div>
        ...
        <div className="flex justify-end">
          <div className="bg-blue-500 text-white rounded-2xl py-3 px-4 max-w-[80%] ml-auto">
            <p>This looks great! I love the modern feel</p>
          </div>
        ...
        <div className="flex justify-end">
          <div className="bg-blue-500 text-white rounded-2xl py-3 px-4 max-w-[80%] ml-auto">
            <p>Maybe we could adjust the spacing a bit?</p>
          </div>
          <div className="w-8 h-8 rounded-full bg-gray-300 overflow-hidden flex-shrink-0 ml-2">
            <Image
              src="/images/david.jpg"
